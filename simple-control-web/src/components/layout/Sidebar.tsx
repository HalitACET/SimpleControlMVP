...
import { Users, Cpu, MapPin, Clock, CalendarDays, FileText, ChevronsLeft, ChevronsRight, Layers, Sun } from 'lucide-react';
  ...
  const location = useLocation();
    ...
    const groups = [
    {
      ...
      items: [
        ...
        { label: 'Cihazlar', path: '/devices', icon: <Cpu size={18} /> },
