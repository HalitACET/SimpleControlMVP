...
public class SecurityConfig {
    ...
    /** Yerel gelistirmede web panelinin adresi; sunucuda CORS_ALLOWED_ORIGINS ile verilir. */
    private static final String DEFAULT_ALLOWED_ORIGIN = "http://localhost:5173";

    private final JwtAuthenticationFilter jwtAuthenticationFilter;

    @Value("${cors.allowed-origins:" + DEFAULT_ALLOWED_ORIGIN + "}")
    ...
    /**
     * CORS origin listesi. Joker (*) kullanilmaz: allowCredentials(true) ile birlikte
     * joker origin guvenlik acigidir. Liste bos gelirse yerel varsayilana dusulur —
     * yanlis yapilandirma tum panelin kilitlenmesine yol acmasin.
     *
     * Origin basligi olmayan istekler (mobil uygulama gibi native cagrilar) CORS
     * denetimine hic girmez, bu ayardan etkilenmez.
     */
